...
import com.example.Launcher.controllers.eventhandlers.AddToonController;
import com.example.Launcher.controllers.eventhandlers.EditToonController;
import com.example.Launcher.models.Toon;
import com.example.Launcher.models.manager.ToonListManager;
import com.example.Launcher.utils.ui.StyleManager;
...
public class DisplayController {
    ...
    public void playClicked() {
        ...
        if (!selectedToons.isEmpty()) {
            if (launcherController != null) {  // Ensure launcherController is initialized
                launcherController.launchToons(selectedToons);  // Use the launcher controller to play the selected toons
            } else {
                System.out.println("Launcher Controller is not initialized.");
            }
        } else {
