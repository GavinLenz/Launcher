...
import com.example.ToontownLauncher.controllers.eventhandlers.FormEventHandlers;
...
public class DisplayController {
    ...
    public void playClicked() {
        ...
        List<Toon> selectedToons = toonManager.getToons().stream()
    ...
    public void addToonClicked() {
        try {
            ...
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/com/example/ToontownLauncher/Form.fxml"));
